...
<div class="container login-form">
	...
	<form class="form-signin" role="form" action="process-forget-password" method="post">
		...
		<p>An email with detail instructions has been sent to your address successfully! Follow the instructions to
		...
		<p>
			...
			<input type="email" id="inputEmail" class="form-control input-lg" placeholder="Email address" required
