    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <s:iterator value="dataOut">
          <form class="form-horizontal" role="form" method="post" action="processpatient-question?type=4&allow_comment=1">

            <input type="hidden"  class="form-control" id="inputCategory" placeholder="Title" name="categoryId" value="0">
