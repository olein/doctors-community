					...
					<tbod>
						<s:iterator value="dataOut">
							<tr>
								...
								<td>
									<a href="edit-discussion?id=<s:property value="id"/>"
									   class="btn btn-default">Edit</a>
								</td>
								<td>
									<a href="delete-discussion?type=3&id=<s:property value="id"/>"
									   class="btn btn-default">Delete</a>
								</td>
								<td>
									<a href="discussion-detail?type=3&id=<s:property value="id"/>"
