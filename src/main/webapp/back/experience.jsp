  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        All Experience
        <a href="new-experience" class="btn btn-default pull-right">Add New</a>
      </div>
          ...
          <tbod>
            <s:iterator value="dataOut">
              <tr>
                ...
                <td>
                  <a href="edit-experience?id=<s:property value="id"/>" class="btn btn-default">Edit</a>
                  <a href="delete-experience?id=<s:property value="id"/>"class="btn btn-default">Delete</a>
                </td>
              </tr>
            </s:iterator>
