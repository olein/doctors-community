						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<textarea class="form-control" id="inputAddress" placeholder="Description" rows="3"
										  name="detail"><s:property value="detail"/></textarea>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select class="form-control" id="inputParent" placeholder="Parent Category"
										name="parentId">
									<option value=<s:property value="parentId"/>><s:property
