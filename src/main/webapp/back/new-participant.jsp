      ...
      <div class="panel-body">
        <form class="form-horizontal" role="form" method="post" action="processparticipant">
          <div class="form-group">
            ...
            <select class="form-control" id="inputName" placeholder="User List" name="participants[]" multiple="multiple">
              <option value=0>--select option--</option>
              <s:iterator value="dataOut">
                <option value=<s:property value="id"/>><s:property value="firstName"/> <s:property value="lastName"/></option>
              </s:iterator>
            </select>
          </div>
          <div class="form-group">
