				...
				<s:iterator value="dateOut">
					<form class="form-horizontal" role="form" method="post" action="processeducation">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="inputName" placeholder="Degree"
									   name="degree" value="<s:property value="degree"/>">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="inputAddress" placeholder="Result"
									   name="result" value="<s:property value="result"/>">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="inputTelephone" placeholder="Institute"
									   name="institute" value="<s:property value="institute"/>">
							</div>
						</div>
						<div class="form-group">
