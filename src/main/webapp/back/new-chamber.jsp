            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form" method="post" action="processchamber">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="inputVisitHour" placeholder="12pm-3pm" name="visitingHour" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputVisitDays" class="col-sm-2 control-label">Visiting Days</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="inputVisitDays" placeholder="Monday, Friday" name="visitingDays" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputFees" class="col-sm-2 control-label">Fees</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="inputFees" placeholder="500/=" name="fees" >
                        </div>
                    </div>
                    <div class="form-group">
