					...
					<tbod>
						<s:iterator value="dataOut">
							<tr>
								...
								<td><a href="edit-article?id=<s:property value="id"/>" class="btn btn-default">Edit</a>
								</td>
								<td><a href="delete-article?type=5&id=<s:property value="id"/>" class="btn btn-default">Delete</a>
								</td>
								<td><a href="article-detail?type=5&id=<s:property value="id"/>" class="btn btn-default">more</a>
								</td>
							</tr>
						</s:iterator>
